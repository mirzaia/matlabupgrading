...
Population = 20;       % Total number of duelists in a population
MaxGeneration = 10;     % Maximum Generation/Iteration
...
for Generasi = 1:MaxGeneration
    ...
    for k = 1:Population
        ...
        for ii=1:Dimension
            x(ii,k) = (((DuelistInteger(k,ii)+1)/(10^FightCapabilities))*RangeB(ii))+LB(ii);
        end
