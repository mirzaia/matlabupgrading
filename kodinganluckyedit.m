...
resthick=12.192; %reservoir thickness (m)
reslength=100; %reservoir length (m)
Krock=0.0506126543186054; %thermal conductivity (W/mK)
permeabil= 7.89501E-13; %permeability (m2)
permeabilv= 7.89501E-14; %permeability vertikal (m2)
poros= 0.1035; %porosity batuan
Lling = 116.6862182; %Luas Lingkaran
...
NFRp=(vlcp^2)/(g*dwell); %Froude Number Co2 Injection 
    ...
    %GAS RECOVERY
 mjng=35.34614832+-0.672856976292827*tcr+0.049907089*pcr; %Massa jenis oil (kg/m3)
 viscong=0.000010055+-1.33802257199713E-08*tcr+3.48620620536712E-09*pcr; %viskositas oil (kg/ms)
 ...
 listrik=0.1049; %harga listrik industri di Ohio,USA
 %biaya operasional pompa injeksi co2 per day
 kpci= (pco-pinj)*volci;%kinerja pompa co2 perjam 0.8efficiencypompa watt
 bopc= (kpci)*3600*listrik; %USD/day 0.1049 harga listrik CA,USA
    
 %biaya recycling co2
 brc= CCGRpd*15;%USD/day

 profit=(Rtot-bc-brc-bopc) % menghitung profit
end